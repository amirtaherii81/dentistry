...
class Patient(models.Model):
    ...
    dentist = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='dentist', verbose_name='دندانپزشک مریض')
    diseases = models.ManyToManyField(Disease, related_name='patients', verbose_name='بیماری ها')  # نوع بیماری  
    patient_national_id = models.CharField(max_length=10, unique=True, verbose_name='کد ملی')
    visit_date = models.DateTimeField(auto_now=True, null=True, blank=True, verbose_name='تاریخ مراجعه')  
